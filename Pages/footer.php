...
<div class="black">
    <div class="row">
        <div class="twelve columns text-center">
            <p class="underfooter">SSII dans le Nord - IBM Series AS/400 - Configuration et maintenance d'infrastructure réseau - Agence de communication Web</p>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="large-1 medium-1 small-4 columns text-center copyright">
        CGV
    </div>
    <div class="large-2 medium-2 small-4 columns text-center copyright">
        Recrutement
    </div>
    <div class="large-2 medium-2 small-4 columns text-center copyright">
        Mentions légales
    </div>
    <div class="large-4 medium-4 small-12 columns text-center copyright">
