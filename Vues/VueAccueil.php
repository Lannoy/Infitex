<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Dosis:300,400,600">
        <script src="WebContent/js/vendor/modernizr.js"></script>
    </head>
<body>  
    <?php require($_SERVER['DOCUMENT_ROOT'] . 'Site/Infitex/WebContent/template/header.php'); ?>
    ...
    <div class="offwhite_backgroundcolor">
        <div class="row presentation">
            <div class="text-center">
                ...
                <a href="#" class="button custom_grey_button presentation_button_margin">EN SAVOIR PLUS</a>                
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="row">
            <div class="columns text-center">
                <a href="#" class="button custom_grey_button">NOS REFERENCES WEB</a>
                <a href="#" class="button custom_blue_button website_button_margin">EN SAVOIR PLUS</a>           
            </div>
        </div>
    </div>

    <?php require($_SERVER['DOCUMENT_ROOT'] . 'Site/Infitex/WebContent/template/footer.php'); ?>
